...
int main(int argc, char* argv[]) {
	...
	*/
	...
	int n_folds = 5; //org val 5		// how many folds you want to create from the given dataset
	float l_rate = 0.2f;//org val 0.3f	// how much of an impact shall an error have on a weight
	int n_epoch = 50000000;//org val 500		// how many times should weights be updated
